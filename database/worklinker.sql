...
-- Dumping database structure for etrabaho
CREATE DATABASE IF NOT EXISTS `etrabaho` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `etrabaho`;

-- Dumping structure for table etrabaho.account_deletion_otps
...
-- Dumping data for table etrabaho.account_deletion_otps: 1 rows
DELETE FROM `account_deletion_otps`;
/*!40000 ALTER TABLE `account_deletion_otps` DISABLE KEYS */;
INSERT INTO `account_deletion_otps` (`id`, `contact`, `otp`, `expires_at`, `created_by`, `updated_by`, `created_at`, `updated_at`, `status`, `archived`, `deleted_at`) VALUES
	(1, 'apiloton1@ssct.edu.ph', '829514', '2025-07-21 03:33:27', NULL, NULL, NULL, '2025-07-21 03:23:27', NULL, NULL, NULL);
/*!40000 ALTER TABLE `account_deletion_otps` ENABLE KEYS */;
...
-- Dumping structure for table etrabaho.contracts
...
-- Dumping data for table etrabaho.contracts: 0 rows
DELETE FROM `contracts`;
/*!40000 ALTER TABLE `contracts` DISABLE KEYS */;
/*!40000 ALTER TABLE `contracts` ENABLE KEYS */;

-- Dumping structure for table etrabaho.contract_details
...
-- Dumping data for table etrabaho.contract_details: 0 rows
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('CtM83yqZMW3P9heVATGkYJqNVOT41oougSMzinZb', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36 Edg/138.0.0.0', '', 1753068316),
	('aY5jNFYroQliW3R1oo1qmvCpWgmqSQG3D9XghfS2', 4, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36 Edg/138.0.0.0', '', 1753075979);
